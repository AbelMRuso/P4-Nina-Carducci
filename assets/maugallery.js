(function ($) {
    ...
    $.fn.mauGallery.methods = {
        ...
        prevImage() {
            ...
            // Calcule l’index de l’image précédente dans la galerie, en boucle circulaire
            let previusIndex = (index - 1 + imagesCollection.length) % imagesCollection.length;
            next = imagesCollection[previusIndex] || imagesCollection[imagesCollection.length - 1];
        ...
        nextImage() {
            ...
            //// Calcule l’index de l’image suivant dans la galerie, en boucle circulaire
